...
for row, res in enumerate(results_top10):
    ...
    # if img_show.max() > 1:
    #     img_show = img_show / 255.0  # matplotlib은 0~1 float도 OK
...
plt.savefig(save_dir + "comparison_test_outputs2.png", dpi=300, bbox_inches='tight')
plt.close()
print(f"\n✓ Saved {save_dir}comparison_test_outputs.png")
