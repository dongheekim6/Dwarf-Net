...
#     weight_root = "/userHome/userhome2/donghee/modelcombination/_output/output_clinicdb"
#     dataset_dir = "/userHome/userhome2/donghee/modelcombination/splits"
# if __name__ == "__main__":
#     weight_root = "/userHome/userhome2/donghee/modelcombination/_output/output_colondb"
#     dataset_dir = "/userHome/userhome2/donghee/modelcombination/splits_colondb"
# if __name__ == "__main__":
#     weight_root = "/userHome/userhome2/donghee/modelcombination/_output/output_colondb"
#     dataset_dir = "/userHome/userhome2/donghee/modelcombination/splits_colondb"
if __name__ == "__main__":
    ...
    # model = convsegnet_v2(in_channels=3, out_channels=1)
    # model = polyper(in_channels=3, number_of_classes=1)
    # model = CaraNet(in_channels=3, num_classes=1)
    # model = crc_test_v72(in_channels=3, num_classes=1)
    # model = crc_real_v5(in_channels=3, num_classes=1)
