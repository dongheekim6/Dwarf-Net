...
#module_names = ['convsegnet_v2','UNet','DCSA_UNet','HarDNet_MSEG','CFHA_Net','MEGANet_Res2net'] # ,'CaraNet'
module_names = ['polyper']
# 'DUCKNet' 'crc_real_v4'
Dataset_dir = 'splits_colondb/'
 
model_names = module_names
# from models.PraNet_Res2Net import PraNet_Res2Net 'PraNet_Res2Net',
...
for iteration in range(iterations[0], iterations[1]+1):
    # if iteration == 1:
    #     model_names = ['CFHA_Net','MEGANet_Res2net']
    # else:
    #     model_names = ['convsegnet_v2','CaraNet','UNet','DCSA_UNet','HarDNet_MSEG','CFHA_Net','MEGANet_Res2net']
    ...
    for model_name in model_names:
        ...
        try:
            df.to_csv(output_root+'/'+'Seg_'+setting+"_"+Experiments_Time+'.csv', index=False, header=True, encoding="cp949")
        except:
            now = datetime.now()
